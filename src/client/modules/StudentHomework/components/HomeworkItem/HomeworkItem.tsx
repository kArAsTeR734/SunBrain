...
const HomeworkItem:FC<HomeworkItemProps> = ({
    task
}) => {
        ...
        <>
            <div className="task">
                ...
                <div className="task__actions">
                    ...
                    <Button onClick={() => toggleTaskComplete()} className="task__check">Проверить</Button>
                </div>

                {isTaskComplete && isTaskCorrect
                    ? <TaskSolution/>
                    : ''
                }
            </div>
