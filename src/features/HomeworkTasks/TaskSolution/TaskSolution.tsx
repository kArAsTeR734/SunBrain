        ...
        {isOpen && (
            <div className="solution__content">
              <div className="solution__step">
                <p>
                  <strong>Шаг 1:</strong> Так как треугольник <InlineMath math="ABC" /> равнобедренный,
              ...
              <div className="solution__step">
                <p>
                  <strong>Шаг 4:</strong> Внешний угол при вершине <InlineMath math="B" />:
                </p>
              ...
              <div className="solution__final">
                <p>
                  <strong>Ответ:</strong> <InlineMath math="\angle CBD = 174^\circ" />
                </p>
              </div>
            </div>
        )}
